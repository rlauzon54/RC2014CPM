...
201 REM ***
202 WIDTH 150: REM Must make screen wide to handle ANSI conrol codes
205 PRINT "Press any key to continue..."
206 A=RND:IF INKEY$="" GOTO 206
207 RANDOMIZE(A)
210 GOSUB 15010:RO=3:CO=1:GOSUB 15030
211 PRINT "THE USS ENTERPRISE --- NCC-1701"
212 RO=4:CO=1:GOSUB 15030:PRINT
...
226 PRINT TAB(YY);"       ,---' '-------/ /--,"
227 PRINT TAB(YY);"        '----------------'"
228 RO=4:CO=1:GOSUB 15030:PRINT:NEXT YY
229 RO=11:CO=1:GOSUB 15030
260 REM CLEAR 600
270 Z$="                         "
...
1560 PRINT TAB(3);:A2=0:A3=9:GOSUB 15090:GOSUB 15120:PRINT "  COMBAT AREA      CONDITION RED  ";:GOSUB 15150: PRINT
1561 IF S>200 THEN PRINT:GOTO 1590
1580 PRINT TAB(3);:A2=0:A3=11:GOSUB 15090:GOSUB 15120:PRINT "      SHIELDS DANGEROUSLY LOW     ";:GOSUB 15150: PRINT
1581 PRINT
...
2020 PRINT:PRINT TAB(10);:A2=9:GOSUB 15090: PRINT "** FATAL ERROR **";: PRINT
...
2050 PRINT"CROSS-CIRCUITING TO ENGINE ROOM!!":GOSUB 15150:PRINT:GOTO 6220
...
2420 A2=11:GOSUB 15090:PRINT"   CHIEF ENGINEER SCOTT: 'THE ENGINES WON'T TAKE";
2430 PRINT" WARP";W1;CHR$(8);"!'":GOSUB 15150:GOTO 1990
2470 A2=11:GOSUB 15090:PRINT"WARP ENGINES ARE DAMAGED.  MAXIUM SPEED = WARP 0.2":GOSUB 15150:GOTO 1990
2490 N=INT(W1*8+.5):IF E-N>=0 THEN 2590
2500 A2=9:GOSUB 15090:PRINT"ENGINEERING:  'INSUFFICIENT ENERGY AVAILABLE"
2510 PRINT"               FOR MANEUVERING AT WARP";W1;CHR$(8);"!'":GOSUB 15150
...
3320 S1=INT(S1-X1):S2=INT(S2-X2):A2=11:GOSUB 15090:PRINT"WARP ENGINES SHUT DOWN AT ";
3350 PRINT"SECTOR";S1;CHR$(8);",";S2;"DUE TO BAD NAVIGATION":GOSUB 15150:GOTO 3370
...
3800 A2=9:GOSUB 15090:PRINT"LT. UHURA: MESSAGE FROM STARFLEET COMMAND --"
...
3841 PRINT Q1;CHR$(8);",";Q2;CHR$(8);".'":GOSUB 15150
...
3930 A2=11:GOSUB 15090:PRINT"SHIELD CONTROL SUPPLIES ENERGY TO COMPLETE THE MANEUVER.":GOSUB 15150
3940 S=S+E:E=0:IF S<=0 THEN S=0
3980 RETURN
4000 IF D(3)<0 THEN A2=11:GOSUB 15090:PRINT"LONG RANGE SENSORS ARE INOPERABLE.":GOSUB 15150:GOTO 1990
...
4260 IF D(4)<0 THEN A2=11:GOSUB 15090:PRINT"PHASERS INOPERATIVE.":GOSUB 15150:GOTO 1990
...
4551 A2=0:A3=9:GOSUB 15090:GOSUB 15120:PRINT "*** KLINGON DESTROYED ***";:GOSUB 15150:PRINT:GOTO 4580
...
4700 IF P<=0 THEN A2=9:GOSUB 15090:PRINT"ALL PHOTON TORPEDOES EXPENDED.":GOSUB 15150:GOTO 1990
4730 IF D(5)<0 THEN A2=11:GOSUB 15090:PRINT"PHOTON TUBES ARE NOT OPERATIONAL.":GOSUB 15150:GOTO 1990
...
5110 PRINT:A2=0:A3=9:GOSUB 15090:GOSUB 15120:PRINT "*** KLINGON DESTROYED ***";:GOSUB 15150:PRINT
...
5260 A2=11:GOSUB 15090:PRINT"STAR AT";X3;",";Y3;"ABSORBED TORPEDO ENERGY.":GOSUB 15150:GOSUB 6000
5261 GOTO 1990
5280 A$=">!<":Z1=X:Z2=Y:GOSUB 8830:IF Z3=0 THEN 4760
5330 A2=0:A3=9:GOSUB 15090:GOSUB 15120:PRINT "*** STARBASE DESTROYED ***";:GOSUB 15150: PRINT
...
5530 IF D(7)<0 THEN A2=11:GOSUB 15090:PRINT"SHIELD CONTROL INOPERABLE.":GOSUB 15150:GOTO 1990
...
5700 A2=11:GOSUB 15090:PRINT"DAMAGE CONTROL REPORT NOT AVAILABLE.":GOSUB 15150: IF D0=0 THEN 1990
...
6061 S=S-H:K(I,3)=K(I,3)/(3+RND(1))
6080 PRINT:A2=11:GOSUB 15090:PRINT H;"UNIT HIT ON ENTERPRISE FROM SECTOR";
6081 PRINT K(I,1);CHR$(8);",";K(I,2);CHR$(8);".":GOSUB 15150
6090 IF S<=0 THEN 6240
6100 A2=11:GOSUB 15090:PRINT"      <SHIELDS DOWN TO";S;"UNITS>":GOSUB 15150:IF H<20 THEN 6200
6120 IF RND(1)>.6 OR H/S<=.02 THEN 6200
6140 R1=FNR(1):D(R1)=D(R1)-H/S-.5*RND(1):GOSUB 8790
6170 A2=11:GOSUB 15090:PRINT"DAMAGE CONTROL: '";G2$;" DAMAGED BY THE HIT'":GOSUB 15150
6200 NEXT I:RETURN
...
6730 PRINT:A2=0:A3=9:GOSUB 15090: GOSUB 15120:PRINT"*** SHORT RANGE SENSORS ARE OUT ***";:GOSUB 15150:PRINT:RETURN
6770 O1$="   +--1---2---3---4---5---6---7---8-+":PRINT O1$
6771 FOR I=1 TO 8:PRINT I;"|";
6775 FOR J=(I-1)*24+1 TO(I-1)*24+22 STEP 3
6780 OB$=MID$(Q$,J,3):PRINT " ";
6785 IF OB$="<E>" THEN A2=10:GOSUB 15090
6790 IF OB$=">B<" THEN A2=14:GOSUB 15090
6795 IF OB$=" * " THEN A2=11:GOSUB 15090
6800 IF OB$="+K+" THEN A2=9:GOSUB 15090
6820 PRINT OB$;:GOSUB 15150
6821 NEXT J:PRINT"|";I;
6830 ON I GOTO 6850,6900,6960,7020,7070,7120,7180,7240
6850 PRINT"   STARDATE          ";:PRINT INT(T*10)*.1
6851 GOTO 7260
6900 PRINT"   CONDITION          ";
6901 IF C$="*RED*" THEN A2=0:A3=9:GOSUB 15090: GOSUB 15120: PRINT "*RED*";:GOSUB 15150: PRINT:GOTO 7260  
6902 IF C$="DOCKED" THEN A2=0:A3=14:GOSUB 15090: GOSUB 15120:PRINT "DOCKED";:GOSUB 15150:PRINT:GOTO 7260
6903 IF C$="GREEN" THEN A2=0:A3=10:GOSUB 15090: GOSUB 15120:PRINT "GREEN";:GOSUB 15150:PRINT:GOTO 7260
6904 IF C$="YELLOW" THEN A2=0:A3=11:GOSUB 15090: GOSUB 15120:PRINT "YELLOW";:GOSUB 15150:PRINT:GOTO 7260
6905 PRINT C$: GOTO 7260
...
7125 TE=INT(E+S)
7130 IF TE < 2000 THEN A2=11:GOSUB 15090
7140 IF TE < 1000 THEN A2=9:GOSUB 15090
7150 PRINT TE:GOSUB 15150
7155 GOTO 7260
7180 PRINT"   SHIELDS           ";:PRINT INT(S)
7181 GOTO 7260
7240 PRINT"   KLINGONS REMAINING";:PRINT INT(K9)
7260 NEXT I:PRINT O1$:RETURN
7290 IF D(8)<0 THEN A2=0:A3=9:GOSUB 15090: GOSUB 15120: PRINT"COMPUTER DISABLED.":GOSUB 15150:GOTO 1990
...
7635 IF J=Q2 AND I=Q1 THEN A2=13:GOSUB 15090
7700 PRINT RIGHT$(STR$(Z(I,J)+1000),3);" ";
7705 IF J=Q2 AND I=Q1 THEN GOSUB 15150
...
15010 PRINT CHR$(27);"[2J": RETURN
15020 REM Set cursor pos ro=row, co=col
15030 RO$=STR$(RO):RO$=RIGHT$(RO$,LEN(RO$)-1)
15040 CO$=STR$(CO):CO$=RIGHT$(CO$,LEN(CO$)-1)
15050 X$=CHR$(27)+"["+RO$+";"+CO$+"H"
15060 PRINT X$;
15070 RETURN
15080 REM SET Foreground color A2
15090 A2$=STR$(A2):A2$=RIGHT$(A2$,LEN(A2$)-1)
15100 X$=CHR$(27)+"[38;5;"+A2$+"m":PRINT X$;:RETURN
15110 REM SET Background color A3
15120 A3$=STR$(A3):A3$=RIGHT$(A3$,LEN(A3$)-1)
15130 X$=CHR$(27)+"[48;5;"+A3$+"m":PRINT X$;:RETURN
15140 REM RESET ATTRIBUTES
15150 X$=CHR$(27)+"[0m":PRINT X$;:RETURN