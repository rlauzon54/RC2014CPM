...
201 REM ***
205 INPUT "Enter a random number";A:RANDOMIZE(A)
...
1560 PRINT TAB(3);CHR$(27);"[38;5;0m";CHR$(27);"[48;5;9m";"  COMBAT AREA      CONDITION RED  ";CHR$(27);"[0m"
1561 IF S>200 THEN PRINT:GOTO 1590
1580 PRINT TAB(3);CHR$(27);"[38;5;0m";CHR$(27);"[48;5;11m";"      SHIELDS DANGEROUSLY LOW     ";CHR$(27);"[0m"
1581 PRINT
...
2020 PRINT:PRINT TAB(10);CHR$(27);"[38;5;9m";"** FATAL ERROR **";CHR$(27);"[0m"
...
4551 PRINT CHR$(27);"[38;5;0m";CHR$(27);"[48;5;9m";"*** KLINGON DESTROYED ***";CHR$(27);"[0m":PRINT:GOTO 4580
...
5110 PRINT:PRINT CHR$(27);"[38;5;0m";CHR$(27);"[48;5;9m";"*** KLINGON DESTROYED ***";CHR$(27);"[0m"
...
5330 PRINT CHR$(27);"[38;5;0m";CHR$(27);"[48;5;9m";"*** STARBASE DESTROYED ***";CHR$(27);"[0m"
...
6901 IF C$="*RED*" THEN PRINT CHR$(27);"[38;5;9m*RED*";CHR$(27);"[0m":GOTO 7260  
6902 IF C$="DOCKED" THEN PRINT CHR$(27);"[38;5;14mDOCKED";CHR$(27);"[0m":GOTO 7260
6903 IF C$="GREEN" THEN PRINT CHR$(27);"[38;5;10mGREEN";CHR$(27);"[0m":GOTO 7260
6904 IF C$="YELLOW" THEN PRINT CHR$(27);"[38;5;11mYELLOW";CHR$(27);"[0m":GOTO 7260
